    ...
    public function run()
    {
        ...
        foreach ($processors as $processor) {
            Produk::create([
                ...
                'harga_setelah_diskon' => $processor['harga'],
        ...
        foreach ($motherboards as $motherboard) {
            $savedMotherboards[] = Produk::create([
                ...
                'harga_setelah_diskon' => $motherboard['harga'],
        ...
        foreach ($rams as $ram) {
            Produk::create([
                ...
                'harga' => $ram['harga'],
                'harga_setelah_diskon' => $ram['harga'],
                'diskon' => $ram['diskon'],
                'stok' => $ram['stok'],
                'berat' => $ram['berat'],
                'kondisi' => $ram['kondisi'],
        ...
        foreach ($vgas as $vga) {
            Produk::create([
                ...
                'harga' => $vga['harga'],
                'harga_setelah_diskon' => $vga['harga'],
                'diskon' => $vga['diskon'],
                'stok' => $vga['stok'],
                'berat' => $vga['berat'],
                'kondisi' => $vga['kondisi'],
        ...
        foreach ($storages as $storage) {
            Produk::create([
                ...
                'harga' => $storage['harga'],
                'harga_setelah_diskon' => $storage['harga'],
